...
const DevFestInfo = () => {
  return (
    <section className="relative container mx-auto md:mt-8 pb-6 md:pb-32 px-4 flex flex-col md:flex-row gap-10 md:gap-20 md:items-center md:px-10">
      <div className="md:w-[55%] flex flex-col gap-3">
        <div className="flex items-center gap-1">
          <Image
            ...
            height={72}
            width={200}
            className="h-[50px] w-[130px] md:w-[200px] md:h-[70px]"
          />
          <h1 className="text-3xl md:text-5xl text-[#FFA800] font-medium">Jos</h1>
        </div>
        ...
        <div className="flex gap-14 px-3 md:px-0 md:gap-20 mt-4">
