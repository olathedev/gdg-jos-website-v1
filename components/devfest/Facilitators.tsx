...
const Facilitators = () => {
  ...
  return (
    <section className="w-full bg-[#4285F4] bg-opacity-5 mt-20 py-8 md:py-20 flex flex-col gap-8 items-center whitespace-nowrap">
      <h1 className="text-2xl md:text-[40px] md:mb-10 font-semibold font-inter text-textDark text-center leading-[44px]">
