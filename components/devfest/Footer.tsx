...
const Footer = () => {
    return (
        <footer className="w-full mt-20">
            <div className="h-[300px] bg-[#FFFAEB] flex flex-col gap-4 justify-center items-center text-textDark">
                <h1 className="text-[38px] font-bold font-inter">Devfest Jos 2024</h1>
            ...
            <div className="w-full pt-16 pb-8 bg-[#011433] px-24 flex flex-col gap-10">
