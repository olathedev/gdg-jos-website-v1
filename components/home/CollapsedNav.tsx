...
const CollapsedNav = () => {
  return (
    <m.div initial={{ opacity: 0 }}           // Start invisible
    animate={{ opacity: 1 }}           // Fade in
    exit={{ opacity: 0 }}              // Fade out
    transition={{ duration: 0.5 }} className="absolute top-24 inset-0 z-20 w-full h-screen bg-white  py-32 container mx-auto px-10">
    <div className="w-full h-full relative flex flex-col">

      <Image src='/svgs/sting.svg' alt="" height={400} width={450} className="absolute right-0 top-0" />
      <span className="absolute left-[24rem] bottom-20">
        <BigSpiral />
      </span>
      <div className="flex flex-col gap-4 cursor-pointer">
        <div className="text-3xl font-bold text-textDark">Become a Member</div>
        <div className="text-3xl font-bold text-textDark">Events</div>
        <div className="text-3xl font-bold text-textDark">Dev Fest</div>
        <div className="text-3xl font-bold text-textDark">Become a Partner</div>
        <div className="text-3xl font-bold text-textDark">Become a Member</div>
        <div className="text-3xl font-bold text-textDark">Team</div>
        <div className="text-3xl font-bold text-textDark">Contact Us</div>
